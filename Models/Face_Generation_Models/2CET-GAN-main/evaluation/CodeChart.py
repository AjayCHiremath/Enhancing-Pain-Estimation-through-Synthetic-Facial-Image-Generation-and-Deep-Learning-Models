...
def show(happy, sad, angry):
    ...
    # ax3.set_xlabel('x')
    fig.tight_layout()
    plt.savefig('output/code_chart.jpg')
    plt.show()
...
def code_face(transform, config, models_s):
    ...
    img_f_0 = n_dir + "/115_01.jpg"
    # img_f_0 = config.test_dir + "/a_n/174_01.jpg"
    img_0 = transform(Image.open(img_f_0).convert('RGB'))
    x_0 = torch.unsqueeze(img_0, dim=0)
    xs = [x_0, x_0, x_0, x_0]
    add_org = False
    output_f = "ouput/code_face_CFEE.jpg"

    # img_f_0 = "/Users/$USER/Documents/Repositories/datasets/expression_CFD_256/a_n/CFD-MF-346_n.jpg"
    # img_f_1 = "/Users/$USER/Documents/Repositories/datasets/expression_CFD_256/a_n/CFD-AF-218_n.jpg"
    # img_f_2 = "/Users/$USER/Documents/Repositories/datasets/expression_CFD_256/a_n/CFD-LM-212_n.jpg"
    # img_f_3 = "/Users/$USER/Documents/Repositories/datasets/expression_CFD_256/a_n/CFD-MM-306_n.jpg"
    # img_0 = transform(Image.open(img_f_0).convert('RGB'))
...
def cut_code_face_CFEE():
    img = Image.open("output/code_face_CFEE_20.jpg")
    print(img.size)
    ...
    im.save("code_face_CFEE_21.jpg", format=None)
